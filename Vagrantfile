Vagrant.configure("2") do |config|
  ...
  "metabase"      => { ip: "192.168.10.36", memory: 2048, cpus: 2 },  # BI / Dashboards Odoo
  "n8n"           => { ip: "192.168.10.37", memory: 1024, cpus: 1 },  # Automatisation workflows
  "plane"         => { ip: "192.168.10.38", memory: 2048, cpus: 2 },  # Gestion de projet
}
